...
let temp = res.data.data;
  ...
  getlist2() {
    let that = this;
    wx.request({
      url: 'https://medicalgas.lygyy.com.cn/prod-api/home/mainnet/show',
      method: 'get',
      data: {
        areaId:wx.getStorageSync('areaId'),
      },
      ...
      success: function success(res) {
        if (res.data.code == 200) {
         ...
         if(wx.getStorageSync('areaId')=='1797512499696791554'){
          if1d = temp['空气主管网']?temp['空气主管网']:''
          if2d = temp['氧气主管网']?temp['氧气主管网']:''
          if3d = temp['真空主管网']?temp['真空主管网']:''

          that.setData({
            ef1_press:temp['空气主管网'],
            ef2_press:temp['氧气主管网'],
            ef3_press:temp['真空主管网'],
            ef1:{onInit: initf1},
            ef2:{onInit: initf2},
            ef3:{onInit: initf3},
          });
  ...
  getlist3() {
    ...
    wx.request({
      ...
      success: function success(res) {
        if (res.data.code == 200) {
          console.log("hplhplhplhplhpl",res.data);
         let temp =res.data.data;
  ...
  getlist4() {
    let that = this;
    wx.request({
      url: 'https://medicalgas.lygyy.com.cn/prod-api/home/airunit/show',
      method: 'get',
      data: {
        areaId:wx.getStorageSync('areaId'),
      },
  ...
  getlist5() {
    let that = this;
    wx.request({
      url: 'https://medicalgas.lygyy.com.cn/prod-api/home/vacuumunit/show',
      method: 'get',
      data: {
        areaId:wx.getStorageSync('areaId'),
      },
  ...
  getlist6() {
    let that = this;
    wx.request({
      url: 'https://medicalgas.lygyy.com.cn/prod-api/home/equipment/online/statistics',
      method: 'get',
      data: {
        areaId:wx.getStorageSync('areaId'),
      },
  ...
  getlist7() {
    let that = this;
    wx.request({
      url: 'https://medicalgas.lygyy.com.cn/prod-api/home/alarmbox/show',
      method: 'get',
      data: {
        areaId:wx.getStorageSync('areaId'),
      },
