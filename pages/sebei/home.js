...
Page({
  ...
  getlist() {
    ...
    // }
    wx.request({
      url: CONFIG.subDomain + '/device/info/page',
      method: 'get',
      data: temp,
      header: {
  ...
  go(e) {
    ...
    wx.navigateTo({
      url: "/pages/sebei/detail?id=" + e.currentTarget.dataset.detail.id,
    })
  },
